    ...
    <Layout>
      <div className="pt-6 ml-[25px] mr-[26px] mb-8">
        <div className="w-full flex items-center">
          ...
          <h1
            onClick={onPut}
            className=" flex  w-full absolute left-[87%] text-bb22 font-medium	 text-[14px]">저장</h1>
        </div>
        <div className="flex justify-center mt-[35px] ">
          <label className="relative w-[80px] h-[80px] " htmlFor="img-File">
            ...
            <div className="absolute right-6 bottom-7 w-[24px] h-[24px] p-[4px] rounded-full  shadow-[0_0_10px_0_rgba(0,0,0,0.1)] ">
