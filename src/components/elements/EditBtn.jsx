...
const EditBtn = () => {
  ...
  return (
    <button
      className="fixed bottom-[228px] right-[30px] bg-gradient-to-r from-bbpink to-bbpurple shadow-[0_0_5px_0_rgba(255,121,121,0.5)] rounded-full w-[56px] h-[56px] active:animate-ping"
