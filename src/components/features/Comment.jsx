             ...
             last-of-type:rounded-b-md  bg-white pb-6'
              ...
              <div className='flex justify-between pt-[24px] mb-[8px] '>
                ...
                <div className='flex justify-center items-center'>
                  <Likes data={item.commentId} level={level} isLiked={item.isLiked} itemId={item.commentId} />
                  <p className='text-[12px] h-[14px] font-semibold ml-1'>{item.likeCount}</p>
                </div>

              </div>
              <div className='break-all mb-[8px] text-[12px]'>{item.comment}</div>
