...
const Header = () => {
  ...
  useEffect(() => {
    if (!listening && isLogin) {
      //SSE 연결
      eventSource = new EventSourcePolyfill(`${process.env.REACT_APP_API_URL}/connect`, {
        headers: {
          Authorization:
  ...
  return (
    <div className="flex items-center fixed top-0 px-6 w-full bg-bbLpurple border-b-[0.5px] border-bbBB h-[52px]">
        ...
        <div className="flex items-center">
          ...
          <svg
            ...
            <g clipPath="url(#clip0_801_894)">
              <path d="M8.88337 3C5.08604 3 2 5.68451 2 9C2 10.3308 2.50478 11.5468 3.33078 12.5449L2.90631 14.4379C2.826 14.782 3.22753 15.0803 3.61759 14.9771L5.90057 14.4034C6.80688 14.782 7.80497 15 8.87189 15C12.6692 15 15.7553 12.3155 15.7553 9C15.7553 5.68451 12.6692 3 8.87189 3H8.88337Z" stroke="black" strokeWidth="1.5" strokeLinejoin="round" />
            </g>
            <defs>
          ...
          <svg
            ...
            width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#bxdvyg8zna)" stroke="#000" strokeWidth="1.5" strokeMiterlimit="10">
      ...
      <AlarmAlert newNotice={newNotice} setNewNotice={setNewNotice}></AlarmAlert>
    </div>
  )
}
