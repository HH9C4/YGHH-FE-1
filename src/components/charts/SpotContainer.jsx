...
const SpotContainer = ({ spot, settings, Slider }) => {
  ...
  return (
    <div>
      <article className="rounded-md ml-[25px] mr-[26px]">
        <div
          onClick={onSelect}
          className={
            select
              ? "pl-[24px] pr-[29px] rounded-t-md flex items-center text-[#fff] bg-gradient-to-r from-bbpink to-bbgradientp justify-between h-[48px]"
              : "pl-[24px] pr-[29px] rounded-t-md flex items-center text-bb22 bg-white justify-between h-[48px]"
          }
        >
        ...
        >
          <div>
            <p className="font-medium text-bb66 text-[12px]">
              {spot.ppltn_time}
            </p>
            <Slider {...settings}>
